        ...
        <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
            ...
            <form className='space-y-5' onSubmit={handleSubmit}>
                <div>
                    ...
                    <input type="text" placeholder='Enter Shop Name' className='w-full px-4 py-2 border 
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <input type="text" placeholder='City' className='w-full px-4 py-2 border 
                    rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
                    ...
                    <input type="text" placeholder='State' className='w-full px-4 py-2 border 
                    rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
                ...
                <div>
                    ...
                    <input type="text" placeholder='Enter Shop Address' className='w-full px-4 py-2 border 
                    rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500'
