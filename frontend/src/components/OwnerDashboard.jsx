    ...
    <div className="w-full min-h-screen bg-[#fff9f6] flex flex-col items-center">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 text-sm sm:text-base mb-4">
                Start your food delivery business by adding your restaurant
                details.
              </p>
              <button
                className="bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium 
            shadow-md hover:bg-orange-600 transition-colors duration-200 cursor-pointer"
      ...
      {myShopData && (
        ...
        text-center"
          ...
          <div
            className="bg-white shadow-lg rounded-xl overflow-hidden border-orange-100 hover:shadow-2xl
        transtion-all duration-300 w-full max-w-3xl relative"
          >
            <div
              className="absolute top-4 right-4 bg-[#ff4d2d] text-white p-2 rounded-full shadow:md
          hover:bg-orange-600 transistion-colors cursor-pointer"
              onClick={() => navigate("/create-edit-shop")}
            >
              <FaPen size={20} />
            </div>
