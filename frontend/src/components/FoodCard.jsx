    ...
    overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col'>
        ...
        <div className='flex items-center justify-between mt-auto p-3'>
            ...
            <div className='flex items-center border rounded-full overflow-hidden shadow-sm'>
                <button className='px-2 py-1 hover:bg-gray-100 transition cursor-pointer' onClick={handleDecrese}>
                    <FaMinus size={12} />
                </button>
                <span>{quantity}</span>
                ...
                <button className={` ${cartItems.some(i=>i.id==data._id)?"bg-gray-800":"bg-[#ff4d2d]"} text-white px-3 py-2 transition-colors cursor-pointer`}
                onClick={()=>{
